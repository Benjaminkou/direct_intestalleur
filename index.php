<?php
    ...
    if(isset($_POST['envoyer']))
    {
        ...
        $sql = ("INSERT INTO `logement`(`id_contact`, `proprio`, `maison`, `surface`, `residant`, `chauffage`, `old`, `code_postal`) VALUES(:id_contact, :proprio, :maison, :surface, :residant, :chauffage, :old, :code_postal)");
...
<body>
    ...
    <form action="" method="post">
                            ...
                            <div class="col-lg-6 my-4"><label class="form-label">Bien concerné :</label>
                                ...
                                <div class="form-check"><input class="form-check-input" type="radio" id="maison_false"><label class="form-check-label" for="maison_false">Appartement</label></div>
                            </div>
                            ...
                            <div class="col-lg-6 my-4"><label class="form-label">Votre bien a-t-il 15 ans ou plus ?</label>
                                ...
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-2"><label class="form-check-label" id="old_false" for="formCheck-2" name="old" value="false">Non</label></div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col"><label class="form-label">Code postal</label><input class="form-control" type="text" name="zip"></div>
                                </div>
                        </div>
